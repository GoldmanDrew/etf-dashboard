...
| `bucket4_pairs/{ETF}.json` | production import / research-legacy | Per-pair daily ledger; optional nested `inception_research`; Pair Report | with B4 build |
| `bucket4_inception_research/{ETF}.json` | `scripts/build_b4_inception_research.py` | Labeled research full-history for optional ls-algo `inception_research/` attach | on demand / ops |
