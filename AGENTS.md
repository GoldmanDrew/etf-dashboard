...
| `bucket4_backtest.json` | `scripts/build_bucket4_backtest.py` | B4 schema v2 envelope: production replay, `default_weights`, `pair_series` daily paths, chart B4 production backtest, custom book lab | nightly (after full `build_data`) |
