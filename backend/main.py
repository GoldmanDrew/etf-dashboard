...
def _build_records_from_csv():
    ...
    for _, row in UNIVERSE_DF.iterrows():
        ...
        rec = ETFRecord(
            ...
            realized_pair_gross_20d=_v2f(row, "realized_pair_gross_20d"),
            realized_pair_gross_20d_log=_v2f(row, "realized_pair_gross_20d_log"),
            realized_pair_gross_20d_obs=(
                int(row["realized_pair_gross_20d_obs"])
                if "realized_pair_gross_20d_obs" in row and not _isnan(row.get("realized_pair_gross_20d_obs"))
                else None
            ),
            realized_pair_gross_20d_sufficient=_v2bool(row, "realized_pair_gross_20d_sufficient"),
            realized_pair_gross_20d_start_date=_v2s(row, "realized_pair_gross_20d_start_date"),
            realized_pair_gross_20d_end_date=_v2s(row, "realized_pair_gross_20d_end_date"),
            realized_pair_gross_20d_source=_v2s(row, "realized_pair_gross_20d_source"),
            realized_pair_net_20d=_v2f(row, "realized_pair_net_20d"),
            ...
            und_rv_20d_daily_annual=_v2f(row, "und_rv_20d_daily_annual"),
            und_rv_20d_weekly_annual=_v2f(row, "und_rv_20d_weekly_annual"),
            und_trend_ratio_20d=_v2f(row, "und_trend_ratio_20d"),
            und_trend_ratio_fwd_20d=_v2f(row, "und_trend_ratio_fwd_20d"),
            und_trend_regime_prob_trend_20d=_v2f(row, "und_trend_regime_prob_trend_20d"),
            und_trend_regime_prob_chop_20d=_v2f(row, "und_trend_regime_prob_chop_20d"),
            und_trend_estimator_confidence_20d=_v2f(row, "und_trend_estimator_confidence_20d"),
            und_trend_efficiency_20d=_v2f(row, "und_trend_efficiency_20d"),
            und_trend_consistency_20d=_v2f(row, "und_trend_consistency_20d"),
            und_trend_r2_20d=_v2f(row, "und_trend_r2_20d"),
            und_trend_persistence_20d=_v2f(row, "und_trend_persistence_20d"),
            und_rebalance_cadence_score_20d=_v2f(row, "und_rebalance_cadence_score_20d"),
            und_vcr_20d=_v2f(row, "und_vcr_20d"),
            und_return_20d=_v2f(row, "und_return_20d"),
            und_abs_return_20d_pctile=_v2f(row, "und_abs_return_20d_pctile"),
            und_rv_20d_pctile=_v2f(row, "und_rv_20d_pctile"),
            und_trend_ratio_20d_pctile=_v2f(row, "und_trend_ratio_20d_pctile"),
            und_vcr_20d_pctile=_v2f(row, "und_vcr_20d_pctile"),
            und_vcr_20d_median=_v2f(row, "und_vcr_20d_median"),
            und_vol_shape_20d=_v2s(row, "und_vol_shape_20d"),
            und_rv_60d_daily_annual=_v2f(row, "und_rv_60d_daily_annual"),
            und_rv_60d_weekly_annual=_v2f(row, "und_rv_60d_weekly_annual"),
            und_trend_ratio_60d=_v2f(row, "und_trend_ratio_60d"),
            und_trend_ratio_fwd_60d=_v2f(row, "und_trend_ratio_fwd_60d"),
            und_trend_regime_prob_trend_60d=_v2f(row, "und_trend_regime_prob_trend_60d"),
            und_trend_regime_prob_chop_60d=_v2f(row, "und_trend_regime_prob_chop_60d"),
            und_trend_estimator_confidence_60d=_v2f(row, "und_trend_estimator_confidence_60d"),
            und_trend_efficiency_60d=_v2f(row, "und_trend_efficiency_60d"),
            und_trend_consistency_60d=_v2f(row, "und_trend_consistency_60d"),
            und_trend_r2_60d=_v2f(row, "und_trend_r2_60d"),
            und_trend_persistence_60d=_v2f(row, "und_trend_persistence_60d"),
            und_rebalance_cadence_score_60d=_v2f(row, "und_rebalance_cadence_score_60d"),
            und_vcr_60d=_v2f(row, "und_vcr_60d"),
            und_return_60d=_v2f(row, "und_return_60d"),
            und_abs_return_60d_pctile=_v2f(row, "und_abs_return_60d_pctile"),
            und_rv_60d_pctile=_v2f(row, "und_rv_60d_pctile"),
            und_trend_ratio_60d_pctile=_v2f(row, "und_trend_ratio_60d_pctile"),
            und_vcr_60d_pctile=_v2f(row, "und_vcr_60d_pctile"),
            und_vcr_60d_median=_v2f(row, "und_vcr_60d_median"),
            und_vol_shape_60d=_v2s(row, "und_vol_shape_60d"),
            und_trend_estimator_source=_v2s(row, "und_trend_estimator_source"),
            spread=spread0,
            include_for_algo=bool(row.get("include_for_algo", False)),
            strategy_blacklisted=_v2bool(row, "strategy_blacklisted"),
            protected=bool(row.get("protected", False)),
            screener_bucket=_v2s(row, "bucket") or None,
            bucket4_net_edge_annual=_v2f(row, "bucket4_net_edge_annual"),
            init_pct_short=_v2f(row, "init_pct_short"),
            maint_pct_short=_v2f(row, "maint_pct_short"),
            inverse_shortable=_v2bool(row, "inverse_shortable") if "inverse_shortable" in row else None,
            purgatory=_v2bool(row, "purgatory") if "purgatory" in row else None,
            purgatory_net_edge=_v2bool(row, "purgatory_net_edge") if "purgatory_net_edge" in row else None,
            ...
            borrow_forecast_method=_v2s(row, "borrow_forecast_method"),
            borrow_spike_p_5d_l2_boosting=_v2f(row, "borrow_spike_p_5d_l2_boosting"),
            borrow_spike_p_5d_l2_boosting_calibrated=_v2f(row, "borrow_spike_p_5d_l2_boosting_calibrated"),
            borrow_spike_alert_tier_boosting=_v2s(row, "borrow_spike_alert_tier_boosting"),
            borrow_model_drift_winner=_v2s(row, "borrow_model_drift_winner"),
            borrow_model_spike_winner=_v2s(row, "borrow_model_spike_winner"),
            ...
            borrow_ops_policy=_v2s(row, "borrow_ops_policy"),
            borrow_ops_spike_block=_v2bool(row, "borrow_ops_spike_block") if "borrow_ops_spike_block" in row else None,
            borrow_ops_spike_watch=_v2bool(row, "borrow_ops_spike_watch") if "borrow_ops_spike_watch" in row else None,
            borrow_ops_model_disagree=_v2bool(row, "borrow_ops_model_disagree") if "borrow_ops_model_disagree" in row else None,
            borrow_ops_drift_tightening=_v2bool(row, "borrow_ops_drift_tightening") if "borrow_ops_drift_tightening" in row else None,
            borrow_ops_spike_tier_v2=_v2s(row, "borrow_ops_spike_tier_v2"),
            borrow_ops_spike_tier_boosting=_v2s(row, "borrow_ops_spike_tier_boosting"),
            borrow_ops_effective_net_edge_p50=_v2f(row, "borrow_ops_effective_net_edge_p50"),
            schema_v=scv,
