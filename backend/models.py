...
class ETFRecord(BaseModel):
    ...
    realized_pair_gross_20d: Optional[float] = None
    realized_pair_gross_20d_log: Optional[float] = None
    realized_pair_gross_20d_obs: Optional[int] = None
    realized_pair_gross_20d_sufficient: Optional[bool] = None
    realized_pair_gross_20d_start_date: Optional[str] = None
    realized_pair_gross_20d_end_date: Optional[str] = None
    realized_pair_gross_20d_source: Optional[str] = None
    realized_pair_net_20d: Optional[float] = None
    ...
    und_vcr_20d_median: Optional[float] = None
    ...
    und_rv_60d_pctile: Optional[float] = None
    und_trend_ratio_60d_pctile: Optional[float] = None
